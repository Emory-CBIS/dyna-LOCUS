...
# chmod u+x decomposition.sh
# ./decomposition.sh decomposition.R decomp

##################### Change these constants ##############################
analysis=$2      # change for every analysis you run (2nd arg)
maildom='@emory.edu'   # your email domain (for receiving error messages)
myscratch="/home/jran2/dFC/simulation/decomp/scratch"  # location of your persistent scratch dir
resultdir="/home/jran2/dFC/simulation/decomp/scratch/out"  # This is a folder in permanent storage
script=$1      # your code as (R or Python) script (1st arg)
max_jobs=1400    # max number of jobs to run at a time
total_jobs=1400   # total number of jobs
