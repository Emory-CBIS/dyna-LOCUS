...
# chmod u+x gen_Y.sh
# ./gen_Y.sh gen_Y.R gen_Y

##################### Change these constants ##############################
analysis=$2      # change for every analysis you run (2nd arg)
maildom='@emory.edu'   # your email domain (for receiving error messages)
myscratch="/home/jran2/dFC/simulation/gen_Y/scratch"  # location of your persistent scratch dir
resultdir="/home/jran2/dFC/simulation/gen_Y/scratch/out"  # This is a folder in permanent storage
